                     ...
                     <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="media-body text-white" style="padding-top:1.5rem;">
                                ...
                                <p class="mb-0" style="color:whitesmoke;"><i class="fas fa-coins" ></i><span style="color:whitesmoke; margin-left: 3px;"> Points:</span><span style="font-weight: 700;">{{$amount}}</span></p>
