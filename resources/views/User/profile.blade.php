        ...
        <div class="row">
            ...
            <div class="col-xl-8" >
                ...
                <div class="card-box"class="border"style="box-shadow: 0 0px 10px 0 rgb(44 44 45 / 7%)">
                            ...
                            <a class="btn btn-primary float-right" href="{{route('posts.create')}}" style="background-color:#FFB52E; border:none;">Add New Product</a>        
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($posts as $post)
                                <tr>
                                    ...
                                    <td style="max-width:120px;height:20px;"><div class="mt-4"style="height:20px; overflow:hidden">{{$post->product_name}}</div></td>
                                    <td style=""><div class="mt-4">PHP {{$post->price}}</div></td>
                                    <td style=""><div class="mt-4"><i class="far fa-clock" style="color:green"></i> {{$post->created_at->diffForHumans()}}</div></td>
