				...
				<div class="row">
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<a href=""><i class="fab fa-twitter" style="margin-right: 10px; color:#55ACEE;"></i></a>
							<a href=""><i class="fab fa-facebook-f" style="margin-right: 10px; color:#3B5998;"></i></a>
							<a href=""><i class="fab fa-instagram" style="margin-right: 10px; color:#dd4b39;"></i></a>				
							</ul>
						</div>
					</div>
					<div class="col-sm-2">
