			...
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="/image/s.png" alt="swappee" /></a>
						</div>
               ...
               @if (Route::has('login'))
                <!-- <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block"> -->
                    @auth
                        <a href="{{ url('/home') }}" style="font-size:15px; color: #696763;" class="text-sm text-gray-700 underline"><i class="fas fa-home"></i> Home</a>
                    @else
					  <a href="{{ route('login') }}" style="font-size:15px; color: #696763; "  class="text-sm text-gray-400 underline"> <i class="fa fa-sign-in-alt"></i> Login |</a>

                        @if (Route::has('register'))
						<a href="{{ route('register') }}" style="font-size:15px; color: #696763;"class="ml-4 text-sm text-gray-400 underline"><i class="fa fa-user-plus"></i> Register</a>
                        @endif
                    @endauth
                <!-- </div> -->
				...
				<div class="row">
					...
					<div class="col-sm-2">
						<div class="single-widget">
							<h2>Contact</h2>
							<ul class="nav nav-pills nav-stacked">
								<li><i class="fas fa-home" style="font-size: 13px;"><a href="#" style="font-size: 13px;"> Philippines, Caloocan City</a></i></li>
								<li><i class="fas fa-at" style="font-size: 13px;"><a href="#" style="font-size: 13px;"> Swappee@domain.com</a></i></li>
								<li><i class="fas fa-phone" style="font-size: 13px;"><a href="#" style="font-size: 13px;"> +63 1234 4223</a></i></li>
							</ul>
						</div>
					</div>
