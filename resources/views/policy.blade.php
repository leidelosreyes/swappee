...
<div class="container">
    <h1 class="title2">Privacy Policy</h1>
        <p>Effective date: 2021-04-16</p>
        <br>
        <h2>1. Introduction</h2>
        <br>
        <p>Welcome to Swappee.</p>
        <br>
        <p>Swappee (“us”, “we”, or “our”) operates Swappee.com (hereinafter referred to as “Service”).</p>
        <br>
        <p>Our Privacy Policy governs your visit to Swappee.com, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
        <br>
        ...
        <h2>2. Definitions</h2>
        <br>
        <p>SERVICE means the Swappee.com website operated by Swappee.</p>
        <br>
        ...
        <h2>5. Use of Data</h2>
        <br>
        <p>Swappee uses the collected data for various purposes:</p>
        <br>
        ...
        <br>
        <p>Swappee will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
        <br>
        ...
        <br>
        <p>If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at support@swappee.com.</p>
        <br>
        ...
        <br>
        <p>0.4. users are able to change their personal information by emailing us at support@swappee.com.</p>
        <br>
        ...
        <br>
        <p>To exercise your California data protection rights described above, please send your request(s) by email: support@swappee.com.</p>
        <br>
        ...
        <h2>21. Contact Us</h2>
        <br>
        <p>If you have any questions about this Privacy Policy, please contact us by email: swappee6@gmail.com</p>
        <br>
</div>
